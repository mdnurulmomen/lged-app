...
return [
    ...
    'audit_strategic_plan' => [
        ...
        'outcome_indicator_all' => env('API_URL_BEE', '') . '/planning/strategic-plan/all/outcome-indicators',
        ...
        'output_indicator_all' => env('API_URL_BEE', '') . '/planning/strategic-plan/all/output-indicators',
    ],
