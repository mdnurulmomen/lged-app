...
class PlanController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if (isSuccess($draft_plan_book)) {
            ...
            return view('modules.audit_plan.audit_plan.plan.create_entity_audit_plan', compact('party_id', 'rp_id', 'draft_plan_book', 'content', 'cover_info'));
        } else {
    ...
    public function generatePlanPDF(Request $request)
    {
        ...
        $cover = $plans[0];
        array_shift($plans);
        $pdf = \PDF::loadView('modules.audit_plan.audit_plan.plan.partials.audit_plan_book', compact('plans', 'cover'));
