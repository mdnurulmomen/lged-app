...
Route::group(['middleware' => 'jisf.auth'], function () {
    ...
    // Plan Route Start
    Route::get('/plan-dashboard', [\App\Http\Controllers\AuditPlan\AuditPlanDashboardController::class, 'index'])->name('plan.dashboard');

    Route::get('/strategic-plan', [\App\Http\Controllers\AuditPlan\AuditStrategicPlanController::class, 'index'])->name('plan.strategic');

    Route::get('/operational-plan', [\App\Http\Controllers\AuditPlan\AuditOperationalPlanController::class, 'index'])->name('plan.operational');

    Route::get('/annual-plan', [\App\Http\Controllers\AuditPlan\AuditAnnualPlanController::class, 'index'])->name('plan.annual');
