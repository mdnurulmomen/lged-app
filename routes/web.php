...
Route::group(['middleware' => ['jisf.auth', 'auth.bee']], function () {
    ...
    Route::group(['as' => 'audit.plan.', 'prefix' => 'audit-plan/'], function () {
        ...
        Route::group(['as' => 'operational.', 'prefix' => 'operational/'], function () {
            ...
            Route::post('load-directorate-list', [\App\Http\Controllers\AuditPlan\AuditOperationalPlan\OperationalPlanController::class, 'loadDirectorateList'])->name('plan.load-directorate-list');
            Route::post('load-approve-reject-form', [\App\Http\Controllers\AuditPlan\AuditOperationalPlan\OperationalPlanController::class, 'loadApproveOrRejectForm'])->name('plan.load-approve-reject-form');
...
//            Route::post('/submit-audit-plan-to-ocag', [\App\Http\Controllers\AuditPlan\AuditAnnualPlan\AnnualPlanController::class, 'submitPlanToOCAG'])->name('plan.list.submit.plan-to-ocag');
            ...
            Route::post('/store-annual-plan-revised-approval-authority', [\App\Http\Controllers\AuditPlan\AuditAnnualPlan\AnnualPlanRevisedController::class, 'storeAnnualPlanApprovalAuthority'])->name('plan.revised.store-annual-plan-approval-authority');
...
//            Route::post('/generate-audit-plan-pdf', [\App\Http\Controllers\AuditPlan\Plan\PlanController::class, 'generatePlanPDF'])->name('plan.generate-audit-plan-pdf');
    ...
    Route::group(['prefix' => 'calendar/'], function () {
        Route::get('individual', [\App\Http\Controllers\AuditPlan\Calendar\TeamCalendarController::class, 'index'])->name('calendar.individual');
        Route::post('load-teams', [\App\Http\Controllers\AuditPlan\Calendar\TeamCalendarController::class, 'loadTeams'])->name('calendar.load-teams');
        Route::get('team', [\App\Http\Controllers\AuditPlan\Calendar\TeamCalendarController::class, 'index'])->name('calendar.team');
