                                        ...
                                        <ul>
                                            @foreach ($outcome['plan_output'] as $output)
                                                <li>
                                                    <div class="d-flex align-item-center">
                                                        <div class="mr-5">
                                                            <i class="fad fa-book-open text-danger text-hover-success mr-2"></i>{{ $output['output_no'] }}
                                                                ...
                                                                <ul>
                                                                    @foreach ($output['activities'] as $activity)
                                                                        <li>
                                                                            <div class="d-flex align-item-center">
                                                                                <div class="mr-5">
                                                                                    <i class="fad fa-bullseye-arrow text-success text-hover-warning mr-2"></i>{{ $activity['activity_no'] }}
                                                                                    : {{ $activity['title_en'] }}
                                                                                    ...
                                                                                    @if(!empty($activity['children']))
                                                                                        @include('modules.audit_plan.operational.audit_activity.partials.edit_annual_audit_activity_child',['children' => $activity['children']])
                                                                                    @endif
                                                                                </div>
                                                                            </div>
                                                                        </li>
