<x-title-wrapper-return area="#kt_content" url="{{route('audit.plan.annual.plan.all')}}">Plan</x-title-wrapper-return>

<div class="row ml-7 mr-7">
    ...
    <div class="col bg-light-danger px-4 py-8 rounded-xl mb-7">
        <span
            class="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
            <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Communication/Add-user.svg-->
            <svg xmlns="http://www.w3.org/2000/svg" width="24px"
...
<div class="row ml-7 mr-7">
    ...
    <div class="col" id="selected_auditee_entities_area">
