...
<form id="approval_authority_form">
    <input type="hidden" name="psr_approval_type" id="psr_approval_type"  value="{{$psr_approval_type}}">
    <input type="hidden" name="annual_plan_id" id="annual_plan_id"  value="{{$annual_plan_id}}">
    <div class="row">
        <div class="col-md-12 officers_list_area">
            <h5 class="mt-2 mb-4">
{{--                {{empty($current_desk_approval_authority)?'':$current_desk_approval_authority['receiver_name_bn'].'('.$current_desk_approval_authority['receiver_designation_bn'].') কাছে প্রেরিত হয়েছে।'}}--}}
            </h5>
        ...
        [
            ...
            'office_name_eng' => 'Comptroller and Auditor General of Bangladesh',
            'office_name_bng' => 'বাংলাদেশের কম্পট্রোলার এন্ড অডিটর জেনারেল এর কার্যালয়',
            ...
            <div class="text-left mt-5">
                <a tabindex="0" href="javascript:;" role="button" onclick="Annual_Plan_Container.sendPsrSenderToReceiver()"
