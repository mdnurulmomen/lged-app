...
<div class="row pt-6">
    <div class="col-md-12">
        <div class="form-group">
            <label for="risk_assessment_point_{{$risk_assessment_type}}">রিস্ক স্কোর (০-১)</label>
...
<div class="row mt-2">
    <div class="col-md-12">
        <button
            ...
            <i class="fas fa-save mr-2"></i> {{!empty($ap_risk_assessment_list)?'হালনাগাদ করুন':'সংরক্ষণ করুন'}}
        </button>
    </div>
</div>
