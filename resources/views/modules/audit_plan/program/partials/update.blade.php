<div class="row m-0 mb-2 page-title-wrapper d-md-flex align-items-md-center">
    <div class="col-md-6">
        <div class="title py-2">
            <h4 class="mb-0 font-weight-bold"><i class="fas fa-list mr-3"></i>Edit Audit Program</h4>
        </div>
    </div>
            ...
            <div class="card-body pt-3">
                <div class="form-row">
                    <div class="col-sm-12 pl-7 pr-7">
                        <div class="form-row">
                            <div class="col-sm-6 form-group">
                                <label for="area_index">Area Index:</label>
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 form-group">
                                <label for="control_objective">Control Objective:</label>
