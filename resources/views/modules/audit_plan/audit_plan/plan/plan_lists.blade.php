        ...
        @forelse($all_entities['data'] as $entity)
            <li id="daak_container_inbox_1_54_Daptorik" class="daak_list_item list-group-item pl-0 py-2 border-bottom">
                <div class="d-flex justify-content-between align-items-start">
                       <span class="input-group-text bg-transparent border-0" title="Search">
                    ...
                    <div class="pr-2 flex-fill entity_list_item_clickable_area cursor-pointer position-relative"
                         data-party-id="{{$entity['party_id']}}"
                         data-rp-id="{{$entity['id']}}"
                         data-party-name="{{$entity['party_name_en']}}"
                    >
