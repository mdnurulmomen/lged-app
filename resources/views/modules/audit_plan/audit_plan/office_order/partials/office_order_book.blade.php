...
<div id="writing-screen-wrapper" style="font-family:nikoshpdf,serif !important;">
    <div class="pdf-screen bangla-font" style="height: 100%">
        ...
        <div class="bangla-font" style="font-family:nikoshpdf,serif !important;text-align: center;margin: 10px 0 10px 0">
                 ...
                 <div style="margin-top: 15px">
                     <table class="bangla-font" width="100%" border="1">
                         ...
                         <tr class="bangla-font">
                             ...
                             <th class="bangla-font" style="text-align: center">{{enTobn(count($allWorkingDates))}} কর্ম দিবস</th>
                         </tr>
                         </tbody>
                     </table>
                 </div>
