<form id="risk_rating_form">
    <div class="form-row">
        <div class="col-md-12 form-group">
            ...
            {{-- <input placeholder="Rating Weight" class="form-control" type="number" id="risk_weight"> --}}
        ...
        <div class="col-md-12 form-group">
            ...
            <input placeholder="Rating Value" class="form-control" type="number" id="rating_value">
        </div>
        <div class="col-md-12 form-group">
        ...
        <div class="col-md-12 pt-4">
            <button type="button" id="btn_risk_rating_modal_save" class="btn btn-primary ml-auto">Save</button>
        </div>
    </div>
</form>

<script>
    $('#btn_risk_rating_modal_save').click(function () {
        url = "{{ route('settings.risk-ratings.store') }}";
        method = 'POST';
        
        // data = $('#risk_rating_form').serialize();
