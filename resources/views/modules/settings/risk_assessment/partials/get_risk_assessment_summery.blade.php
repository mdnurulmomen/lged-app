        ...
        <tr>
            ...
            @foreach ($sectorassessmentarea['audit_assessment_area_risks'] as $auditAssessmentAreaRisk)
                <td class="text-center">
                    <span class="p-1">
                        {{ $auditAssessmentAreaRisk['x_risk_assessment_impact']['impact_value'] }}
                    </span>

                    <span class="p-1">
                        {{ $auditAssessmentAreaRisk['x_risk_assessment_likelihood']['likelihood_value'] }}
                    </span>
                </td>
            @endforeach
            ...
            <td>
                ...
                {{
                    $totalLikelihoodAndImpact = collect($sectorassessmentarea['audit_assessment_area_risks'])->sum(function ($areaRisk) {
                        return $areaRisk['x_risk_assessment_impact']['impact_value'] + $areaRisk['x_risk_assessment_likelihood']['likelihood_value'];
                    })
                }}
            </td>
