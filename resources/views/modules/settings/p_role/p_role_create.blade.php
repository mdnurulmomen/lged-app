<form autocomplete="off" id="role_create_form">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="user_level" name="user_level"
    ...
    <div class="d-flex justify-content-end">
        <a href="javascript:;" role="button" onclick="Role_Create_Container.storeRole()"
