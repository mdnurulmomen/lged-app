...
<div>
    ...
    <div class="pdf-screen bangla-font" style="height: 100%;">
        <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
        {!! $auditReport[4]['content'] !!}
    </div>

    {{--chapter one details page 1--}}
    <div class="pdf-screen bangla-font" style="height: 100%;page-break-after: always;">
        <div>{!! $auditReport[5]['content'] !!}</div>
        <div style="margin-top: 3px">{!! $auditReport[6]['content'] !!}</div>
        <div style="margin-top: 3px">{!! $auditReport[7]['content'] !!}</div>
    </div>

    {{--chapter one details page 2--}}
    <div class="pdf-screen bangla-font" style="height: 100%;page-break-after: always;">
        <div>{!! $auditReport[8]['content'] !!}</div>
        <div style="margin-top: 3px">{!! $auditReport[9]['content'] !!}</div>
        <div style="margin-top: 3px">{!! $auditReport[10]['content'] !!}</div>
    </div>

    {{--chapter one (executive_summary_page)--}}
    <div class="pdf-screen bangla-font" style="height: 100%;page-break-after: always;">
        <div>{!! $auditReport[11]['content'] !!}</div>
    </div>

    {{--chapter one (abbreviation_words_page)--}}
    <div class="pdf-screen bangla-font" style="height: 100%;page-break-after: always;">
        <div>{!! $auditReport[12]['content'] !!}</div>
    </div>

    {{--chapter two cover page--}}
    <div class="pdf-screen bangla-font" style="height: 100%;">
        <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
        {!! $auditReport[13]['content'] !!}
    </div>

    {{--apotti summary page--}}
    <div class="pdf-screen bangla-font" style="height: 100%;page-break-after: always">
        {!! $auditReport[14]['content'] !!}
    </div>

    {{--apotti details cover page--}}
    <div class="pdf-screen bangla-font" style="height: 100%;">
        <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
        {!! $auditReport[15]['content'] !!}
    </div>

    {{--apotti details page--}}
    <div class="pdf-screen bangla-font">
        {!! $auditReport[16]['content'] !!}
    </div>

    {{--part two cover page--}}
    <div class="pdf-screen bangla-font" style="height: 100%;">
        <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
        {!! $auditReport[17]['content'] !!}
    </div>

    {{--porisistho cover page--}}
    <div class="pdf-screen bangla-font" style="height: 100%;">
        <p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
        {!! $auditReport[18]['content'] !!}
    </div>
