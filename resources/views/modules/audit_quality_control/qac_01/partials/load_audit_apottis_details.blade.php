@foreach($apottis as $apotti)
    @if($qac_type == 'qac-1')
        @if($apotti['is_delete'] == 0 && ($apotti['apotti_type'] == 'sfi' || $apotti['apotti_type'] == 'non-sfi'))
    ...
    @elseif($qac_type == 'qac-2')
        @if($apotti['is_delete'] == 0 && $apotti['apotti_type'] == 'sfi' && $apotti['final_status'] == 'draft')
            <div class="pdf-screen bangla-font" style="height: 100%">
                <div style="font-weight: bold">
                    অনুচ্ছেদ নং-{{enTobn($apotti['onucched_no'])}}
                </div>
    ...
    @elseif($qac_type == 'cqat')
        @if($apotti['is_delete'] == 0 && $apotti['apotti_type'] == 'sfi' && $apotti['final_status'] == 'approved')
            <div class="pdf-screen bangla-font" style="height: 100%">
                <div style="font-weight: bold">
                    অনুচ্ছেদ নং-{{enTobn($apotti['onucched_no'])}}
                </div>
