...
<form class="pl-4 pt-4">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" placeholder="Audit Due Year" id="audit_due_year" name="audit_due_year">
        </div>
    ...
    <div class="row">
        <button type="button" onclick="MIS_RPU_LIST_CONTAINER.loadRupLists()" class="btn btn-primary">Submit</button>
    </div>
</form>
