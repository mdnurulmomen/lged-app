    ...
    <div class="pdf-screen bangla-font" style="height: 100%">
        ...
        <div style="margin-left: 10px" class="row">
            <table class="bangla-font">
                <tr class="bangla-font">
                    <td class="bangla-font">বৈঠক নং :</td>
                    <td class="bangla-font">
                        {{$meeting['meeting_no']}}
                    </td>
                </tr>
                <tr class="bangla-font">
                    <td class="bangla-font">বৈঠকের তারিখ :</td>
                    <td class="bangla-font">
                        {{$meeting['meeting_date']}}
                    </td>
                </tr>
                <tr>
                    <td class="bangla-font">সংসদ নং :</td>
                    <td class="bangla-font">
                        {{$meeting['parliament_no']}}
                    </td>
                </tr>
                <tr>
                    <td class="bangla-font">আলোচ্য সূচী:</td>
                    <td class="bangla-font">
                        {{$meeting['meeting_subject']}}
                    </td>
                </tr>
                <tr>
                    <td valign="top" class="bangla-font">বৈঠকের স্থান: </td>
                    <td class="bangla-font">
        ...
        <div class="bangla-font" style="height: 100%;margin-top: 10px;padding-left: 10px">
            <b>বৈঠকে উপস্থিত কমিটির সদস্য গনের তালিকা :</b>
            <div style="padding-left: 15px;padding-top:5px">
                @foreach($meeting['meeting_members'] as $members)
                    <p style="margin: 0px">{{enTobn($loop->iteration)}}. {{$members['member_bn']}}</p>
                @endforeach
            </div>
        </div>

        <div class="bangla-font" style="height: 100%;margin-top: 10px;padding-left: 10px">
            <b>বৈঠকে উপস্থিত মন্ত্রণালয় / বিভাগের কর্মকর্তাগণের তালিকা :</b>
            <div style="padding-left: 15px;padding-top:5px">
                @foreach($meeting['meeting_members'] as $members)
                    @if($members['member_type'] == 'ministry')
                        <p style="margin: 0px">{{enTobn($loop->iteration)}}. {{$members['member_bn']}}</p>
                    @endif
                @endforeach
            </div>
        ...
        <div class="bangla-font" style="height: 100%;margin-top: 10px;padding-left: 10px">
            <b>বৈঠকে উপস্থিত সিএজি কার্যালয়ের কর্মকর্তাগণের তালিকা:</b>
            <div style="padding-left: 15px;padding-top:5px">
                @foreach($meeting['meeting_members'] as $members)
                    @if($members['member_type'] == 'cag')
                        <p style="margin: 0px">{{enTobn($loop->iteration)}}. {{$members['member_bn']}}</p>
                    @endif
                @endforeach
            </div>
        ...
        <div class="bangla-font" style="height: 100%;margin-top: 10px;padding-left: 10px">
            <b>বৈঠকে উপস্থিত অডিট অধিদপ্তর এর কর্মকর্তাগণের তালিকা :</b>
            <div style="padding-left: 15px;padding-top:5px">
                @foreach($meeting['meeting_members'] as $members)
                    @if($members['member_type'] == 'directorate')
                        <p style="margin: 0px">{{enTobn($loop->iteration)}}. {{$members['member_bn']}}</p>
                    @endif
                @endforeach
            </div>
        ...
        <div class="bangla-font" style="height: 100%;margin-top: 10px;padding-left: 10px">
            <b>বৈঠকে উপস্থিত সংসদ সচিবালয়ের কর্মকর্তাগণের তালিকা :</b>
            <div style="padding-left: 15px;padding-top:5px">
                @foreach($meeting['meeting_members'] as $members)
                    @if($members['member_type'] == 'pac')
                        <p style="margin: 0px">{{enTobn($loop->iteration)}}. {{$members['member_bn']}}</p>
                    @endif
                @endforeach
            </div>
                    ...
                    @foreach($meeting['meeting_apottis'] as $apotti)
                        <tr class="bangla-font">
                            ...
                            <td class="bangla-font" style="text-align: right">
                                {{$apotti['total_onishponno_jorito_ortho_poriman']}}
                            </td>
                        </tr>
                    @endforeach
