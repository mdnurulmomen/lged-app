<table class="table table-bordered" width="100%">
    ...
    <tr class="bg-hover-warning">
        ...
        @if(in_array('project',$columns))
            <th class="text-center" width="5%">প্রকল্প </th>
        @endif
    ...
    @forelse($apotti_list['data'] as $apotti)
        <tr>
            ...
            @endif
                ...
                @if(in_array('project',$columns))
                    <td class="text-left">{{$apotti['project_name_bn']}}</td>
                @endif
            ...
            @if(in_array('audit_year',$columns))
                <td class="text-left" width="10%">{{enTobn($apotti['audit_year_start'])}}
                    -{{enTobn($apotti['audit_year_end'])}}</td>
            @endif
