<form id="onucched_marge_form">
    <div class="form-row pt-4">
        ...
        <div class="col-md-12 mb-2">
            ...
            <textarea class="form-control mb-1" name="irregularity_cause" placeholder="অনিয়মের কারণ" cols="30"
                      rows="2"></textarea>
        </div>

        <div class="col-md-12 mb-2">
            <label class="col-form-label">অডিট প্রতিষ্ঠানের জবাব</label>
            <textarea class="form-control mb-1" name="response_of_rpu" placeholder="নিরীক্ষিত প্রতিষ্ঠানের জবাব"
                      cols="30"
                      rows="2"></textarea>
        </div>
        ...
        <div class="col-md-12 mb-2">
            ...
            <textarea class="form-control mb-1" name="audit_conclusion" placeholder="নিরীক্ষা মন্তব্য" cols="30"
                      rows="2"></textarea>
        </div>

        <div class="col-md-12 mb-2">
            <label class="col-form-label">নিরীক্ষার সুপারিশ</label>
            <textarea class="form-control mb-1" name="audit_recommendation" placeholder="নিরীক্ষার সুপারিশ" cols="30"
                      rows="2"></textarea>
        </div>
    </div>
