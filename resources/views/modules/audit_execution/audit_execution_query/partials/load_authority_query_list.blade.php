@if(!empty($audit_query_list))
    ...
    <div class="toolbar flex-wrap justify-content-between shadow-sm pl-1 d-flex border-bottom">
        ...
        <div id="daak_pagination_panel" class="float-right d-flex align-items-center" style="vertical-align:middle;">
                <span class="mr-2"><span id="daak_item_length_start">১</span> - <span id="daak_item_length_end">{{enTobn(count($audit_query_list))}}</span> সর্বমোট: <span
                        id="daak_item_total_record">{{enTobn(count($audit_query_list))}}</span></span>
            <div class="btn-group">
