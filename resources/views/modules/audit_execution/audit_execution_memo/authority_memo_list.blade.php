        ...
        <div class="row mt-2 mb-2">
            ...
            <div class="col-md-3">
                <select class="form-select select-select2" id="memo_irregularity_sub_type">
                    ...
                    <option value="5">রেসপন্সিভ সর্বনিম্ন দরদাতার স্থলে উচ্চ দরদাতার নিকট থেকে কার্য/পণ্য/সেবা ক্রয়
                    </option>
            ...
            <div class="col-md-3">
                <input class="form-control mb-1 mt-1 year-picker" id="audit_year_start"
...
<script>
    ...
    $('#directorate_filter').change(function (){
        Authority_Memo_Container.loadActivityWiseAuditPlan();
    });
    ...
    var Authority_Memo_Container = {
            ...
            if (fiscal_year_id) {
                ...
                ajaxCallAsyncCallbackAPI(url, data, 'POST', function(response) {
                    if (response.status === 'error') {
                        ...
                        Authority_Memo_Container.setActivityAnonymously();
        ...
        paginate: function(elem) {
            ...
            Authority_Memo_Container.loadMemoList(page, per_page);
        },
    };
