...
<div id="writing-screen-wrapper" style="font-family:solaimanlipipdf,serif !important;">
    <div class="pdf-screen bangla-font" style="height: 100%">
        ...
        <table class="bangla-font table table-bordered table-dark" style="width: 100%;margin-top: 10px;padding: 5px;color: black"
               >
        ...
        <table class="bangla-font table table-bordered table-striped" style="width: 100%;margin-top: 10px;padding: 5px;color: black">
            <tr>
