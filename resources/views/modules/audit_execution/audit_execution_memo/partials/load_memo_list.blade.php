...
<div class="table-responsive">
    <table class="table table-striped">
        ...
        <tr>
            ...
            <th width="7%" class="text-left">মেমো নং</th>
            ...
            <th width="10%" class="text-left">নিরীক্ষিত প্রতিষ্ঠান</th>
            <th width="10%" class="text-left">নিরীক্ষিত ধরন</th>
            <th width="10%" class="text-left">নিরীক্ষা বছর</th>
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group btn-group-sm" role="group">
                        ...
                        <button title="মেমো লগ" class="mr-1 btn btn-icon btn-square btn-sm btn-light btn-hover-icon-danger btn-icon-primary"
                                data-memo-id="{{$memo['id']}}"
                        ...
                        <button title="সম্পাদন" class="mr-1 btn btn-icon btn-square btn-sm btn-light btn-hover-icon-danger btn-icon-primary"
                                data-memo-id="{{$memo['id']}}"
