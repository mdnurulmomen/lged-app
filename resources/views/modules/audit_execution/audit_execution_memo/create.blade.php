                    ...
                    <div class="col-md-7">
                        <div class="card">
                            <div class="card-body p-4">
                                ...
                                <textarea class="form-control mb-1" name="memo_title_bn" placeholder="শিরোনাম লিখুন" cols="30" rows="2"></textarea>
                                ...
                                <textarea class="form-control mb-1" name="response_of_rpu" placeholder="অডিটি প্রতিষ্ঠানের জবাব" cols="30" rows="2"></textarea>
