...
<div class="card sna-card-border d-flex flex-wrap flex-row mb-2">
    <div class="col-xl-12 text-left">
        <span style="font-size: 18px"><b>অডিট রিপোর্টের নাম :</b>{{$report_details['audit_report_name']}}</span>
        <br>
        <span style="font-size: 18px"><b>রিপোর্টের সন :</b> {{enTobn($report_details['ortho_bochor'])}}</span>
    </div>
</div>
