...
<div class="card sna-card-border mt-2">
    <div class="table-responsive load-table-data" data-href="{{ route('risk-assessment.risk-matrixes.list') }}">
    </div>
</div>
...
<script>
     $(function () {
        ...
        $('.btn_create_risk_matrix').click(function () {
            
            url = "{{ route('risk-assessment.risk-matrixes.create') }}";
            ...
            ajaxCallAsyncCallbackAPI(url, data, 'GET', function (response) {
                ...
                if (response.status === 'error') {
                    ...
                    $(".offcanvas-title").text('Auditability Matrix Score');
