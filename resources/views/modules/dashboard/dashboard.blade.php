...
@section('content')
    <div class="row mt-35 d-flex flex-column flex-item-center mb-10">
    ...
    <div class="row mb-5">
        <a style="background-color: #F5F5FB!important;" href="{{route('audit.execution.archive-apotti.archive-page')}}" class="col bg-light-warning rounded-xl mr-7 text-center h-200px">
            <img class="mt-5" width="80px" height="80px" src="{{asset('assets/images/repository.png')}}" alt="">
            <p style="color: black" class="font-weight-bold font-size-h1 mt-5">Repository</p>
        </a>
    </div>
@endsection
