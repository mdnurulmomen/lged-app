    ...
    <div class="btn btn-dropdown w-auto btn-clean d-flex align-items-center btn-square px-2 py-0 h-100">
        @if (isset($userDetails['user_role_id']) && $userDetails['user_role_id'] == 3)
            <div class="top-right-username">
                ...
                <div class="profile-designation mt-4">{{ isset($userOffices) ? $userOffices[0]['designation'] : '' }}
                </div>
            </div>
...
<div
    ...
    <div class="shadow">
        ...
        <div class="btn-group w-100 d-flex justify-content-between" role="group" aria-label="User Profile Management">
            <button onclick="Generic_Container.show_user_profile()" data-toggle="popover" data-placement="bottom"
                data-content="{{ __('প্রোফাইল') }}"
            ...
            <a href="{{ asset('Documentation on AMMS.pdf') }}" download>
