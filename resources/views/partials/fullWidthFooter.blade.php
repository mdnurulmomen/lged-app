<div class="footer bg-white d-flex flex-lg-column shadow-sm position-relative" id="kt_footer">
    <!--begin::Container-->
    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between py-4">
        ...
        <!--end::Nav-->
        <div class="text-dark">
           <img src="{{ asset('assets/images/tapp_logo.png') }}"> Develop By <a href="https://tappware.com/">Tappware</a> 
        </div>
        <!--end::Copyright-->
